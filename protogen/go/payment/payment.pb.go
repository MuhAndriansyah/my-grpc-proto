...
import (
	cart "github.com/MuhAndriansyah/my-grpc-proto/protogen/go/cart"
...
type PaymentRequest struct {
	...
	Cart        *cart.Cart `protobuf:"bytes,1,opt,name=cart,proto3" json:"cart,omitempty"`
...
func (x *PaymentRequest) GetCart() *cart.Cart {
	if x != nil {
		return x.Cart
	}
	return nil
...
var file_proto_payment_payment_proto_rawDesc = []byte{
	...
	0x63, 0x6f, 0x6d, 0x2f, 0x4d, 0x75, 0x68, 0x41, 0x6e, 0x64, 0x72, 0x69, 0x61, 0x6e, 0x73, 0x79,
	0x61, 0x68, 0x2f, 0x6d, 0x79, 0x2d, 0x67, 0x72, 0x70, 0x63, 0x2d, 0x70, 0x72, 0x6f, 0x74, 0x6f,
	0x2f, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x67, 0x65, 0x6e, 0x2f, 0x67, 0x6f, 0x2f, 0x70, 0x61, 0x79,
...
var file_proto_payment_payment_proto_goTypes = []any{
	...
	(*cart.Cart)(nil),       // 2: transaction.Cart
}
